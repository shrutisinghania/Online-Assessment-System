...
sql="insert into exam(email,1given,2given,3given,4given,5given,6given,7given,8given,9given,10given,finalscore) values('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')"%(dat,given1,given2,given3,given4,given5,given6,given7,given8,given9,given10,ts)
try:
	cursor.execute(sql)
	db.commit()
	print('<html>')
